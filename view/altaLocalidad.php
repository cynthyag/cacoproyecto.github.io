...
<body class="bg-light">
    ...
    <div class="container">
        <div class="py-4 text-center">
            ...
            <h2>Atla de Localidad</h2>
        </div>

        <div class="col-md-12 text-center">
            <form action="../controller/altaLocalidad.php" method="post" class="needs-validation" >
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="idProvincia" name="idProvincia">
